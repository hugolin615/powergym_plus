...
def get_info_and_folder(env_name):
    ...
    current_dir = os.path.dirname(os.path.abspath(inspect.getsourcefile(volt_var)))

    # Go up one level to the first 'volt_var' directory
    project_root = os.path.dirname(current_dir)

    # Construct the path to the 'systems' directory
    folder_path = os.path.join(project_root, 'systems')
    # folder_path = os.path.join(project_root, 'volt_var', 'systems')
